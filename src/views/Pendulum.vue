...
export default {
    ...
    mounted() {
        ...
        fabric.Image.fromURL(require('../assets/images/pendulum_stick_short.png'), (img) => {
            this.imgs.stick = img
            this.imgsLoaded++
        });
    ...
    methods: {
        ...
        pendulumCallback() {
            ...
            this.pendulum = new fabric.Group([cart, this.stick, gear, gearScrew, screw], {
                centeredRotation: false,
                originX: 'center',
                originY: 'bottom',
            })

            let mainGroup = new fabric.Group([pole, leftLeg, rightLeg, this.pendulum], {
                centeredRotation: false,
                originX: 'center',
                originY: 'bottom',
                top: canvasWidth,
