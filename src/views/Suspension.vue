...
export default {
  ...
  mounted() {
    ...
    fabric.Image.fromURL(require("../assets/images/brakes.png"), img => {
      this.imgs.brakes = img
      this.imgsLoaded++
    })

    fabric.Image.fromURL(require("../assets/images/wheel_offroad.png"), img => {
      this.imgs.wheel = img
      this.imgsLoaded++
    })
  ...
  methods: {
    carCallback() {
      ...
      let groundGroup = new fabric.Group([
        ground,
        tape,
        emptySpot,
        leftBelt,
      ...
      this.spinners = new fabric.Group(
        [leftSpinner, rightSpinner, spinnerCage],
        {
          objectCaching: false
        }
      )
